  ...
  return (
     <div>
      <button
        ...
        onClick={onClick}
      >
        <h2 className="cursor-pointer text-xl font-mono text-start">{title}</h2>
        <span className="plus-icon text-2xl">{isOpen ? <MdOutlineKeyboardArrowUp /> : <MdKeyboardArrowDown />}</span>
      </button>
      {isOpen && (
        <div className="flex flex-col md:flex-row border-solid border rounded-sm">
